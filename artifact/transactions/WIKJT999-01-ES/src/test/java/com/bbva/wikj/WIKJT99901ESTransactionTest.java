...
/**
 * Test for transaction WIKJT99901ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT99901ESTest.xml" })
public class WIKJT99901ESTransactionTest {

	@Autowired
	private WIKJT99901ESTransaction transaction;
